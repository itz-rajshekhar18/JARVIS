...
INPUT_FRAMES_PER_BLOCKS = int(RATE * INPUT_BLOCK_TIME)
...
class TapTester(object):
    ...
    def open_mic_stream(self):
        ...
        stream = self.pa.open(format = FORMAT,
                              ...
                              frames_per_buffer=INPUT_FRAMES_PER_BLOCKS)
    ...
    def listen(self):
        try:
            block = self.stream.read(INPUT_FRAMES_PER_BLOCKS)
        except IOError as e:
            self.errorcount += 1
